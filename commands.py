...
▪️ <a href="https://t.me/projectblaze/88817" >Screenshots</a>
...
'''
    await context.bot.send_photo(CHAT_ID, photo=open('images/blaze3.2.jpg', 'rb'), caption=mess, reply_to_message_id=mess_id, parse_mode='HTML')
