...
▪️ <a href="https://t.me/projectblazeupdates/1282" >Screenshots</a>
...
'''
    await context.bot.send_photo(CHAT_ID, photo=open('images/blaze2.10.jpg', 'rb'), caption=mess, reply_to_message_id=mess_id, parse_mode='HTML')
