...
▪️ <a href="https://t.me/projectblaze/48585" >Screenshots</a>
...
'''
    await context.bot.send_photo(CHAT_ID, photo=open('images/blaze2.1.png', 'rb'), caption=mess, reply_to_message_id=mess_id, parse_mode='HTML')
